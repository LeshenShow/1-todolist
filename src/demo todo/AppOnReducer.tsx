...
//     const action = removeTodolistAC({ id: todolistId }); // двойной вызов создает 2 объекта в памяти
//     dispatchTodolists(action);
//     dispatchTasks(action);
//   };
//   const addTodolist = (title: string) => {
//     const action = addTodolistAC({ title }); // из-за генерации id в AC нам надо объединить, для избежания конфликта
//     dispatchTodolists(action);
//     dispatchTasks(action);
//   };
